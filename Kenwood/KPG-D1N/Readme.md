...
- [VHF](#vhf)
        - [VTAC ANALOG](#vtac-analog)
        - [VHF PSC ANALOG](#vhf-psc-analog)
        - [VHF FED INC RESP ANALOG](#vhf-fed-inc-resp-analog)
        - [VHF FED LAW P25](#vhf-fed-law-p25)
        - [VHF FIRE DIST P25](#vhf-fire-dist-p25)
        - [MARINE 1007-1083 ANALOG](#marine-1007-1083-analog)
        - [MARINE 6-28 ANALOG](#marine-6-28-analog)
        - [MARINE 67-88 ANALOG](#marine-67-88-analog)
        - [DCR VHF ANALOG](#dcr-vhf-analog)
        - [BRK-HMP-WMLC-D14 ANALOG](#brk-hmp-wmlc-d14-analog)
        - [MEMA P25](#mema-p25)
- [UHF](#uhf)
        ...
        - [UHF FED LAW (FED LE U) P25](#uhf-fed-law-fed-le-u-p25)
        - [BAPERN (BAPERN, BUT SMALLER) P25](#bapern-bapern-but-smaller-p25)
        - [BERKSHIRE UHF (BERK UHF) ANALOG](#berkshire-uhf-berk-uhf-analog)
        - [WMLEC UHF (WMLEC U) ANALOG](#wmlec-uhf-wmlec-u-analog)
        - [FD DIST 6-8-14 (FD6-8-14) ANALOG](#fd-dist-6-8-14-fd6-8-14-analog)
        - [METRO FIRE D13 (METRO 13) ANALOG](#metro-fire-d13-metro-13-analog)
        - [MBHSR-MPA (MBHSRMPA) ANALOG](#mbhsr-mpa-mbhsrmpa-analog)
